...
const Practice4 : React.FC = () => {
	...
	return (
		<div className="flex flex-col gap-5">
			...
			<form className="flex items-center flex-col py-3 gap-10" onSubmit={handleSubmit(onSubmit, onError)} onKeyDown={handleKeyDown} noValidate>
				<div className="flex">
					<label className="font-bold" htmlFor="zip">郵便番号</label>
				...
				<div className="flex">
					<label className="font-bold" htmlFor="pref">都道府県</label>
					<div className="ml-2 relative">
				...
				{submitable ? <button className="p-form__submit" type="submit" >送信</button>:<p className="text-red-600 mt-12">該当する住所がありません</p>}
			</form>
		</div>
